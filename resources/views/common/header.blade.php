            ...
            <div class="c-navbar-wrapper clearfix">
                <div class="c-brand c-pull-left">
                    <a href="index.html" class="c-logo">
                        <img src="../img/logo-3.png" alt="金砖华荣" height="30px;" class="c-desktop-logo">
                ...
                <nav class="c-mega-menu c-pull-right c-mega-menu-dark c-mega-menu-dark-mobile c-fonts-uppercase c-fonts-bold">
                    <ul class="nav navbar-nav c-theme-nav">
                        ...
                        <li class="c-menu-type-classic">
                            <a href="{{route('about')}}" class="c-link dropdown-toggle">关于金砖
                                <span class="c-arrow c-toggler"></span>
                            </a>
                            <ul class="dropdown-menu c-menu-type-classic c-pull-left">
                                ...
                                <li class="dropdown-submenu">
                                    <a href="{{route('concept')}}">投资理念
                                        <span class="c-arrow c-toggler"></span>
                                    </a>
                                </li>
                                <li class="dropdown-submenu">
                                    <a href="{{route('team')}}">专业团队
                                        <span class="c-arrow c-toggler"></span>
                                    </a>
                                </li>
                                <li class="dropdown-submenu">
                                    <a href="{{route('risk')}}">合规风控
                                        <span class="c-arrow c-toggler"></span>
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li>
                            <a href="javascript:;" class="c-link dropdown-toggle">产品与服务
                                <span class="c-arrow c-toggler"></span>
                            </a>
                        ...
                        <li>
                            <a href="javascript:;" class="c-link dropdown-toggle">金砖动态
                                <span class="c-arrow c-toggler"></span>
                            </a>
                            <ul class="dropdown-menu c-menu-type-mega c-menu-type-fullwidth" style="min-width: auto">
                                <li>
